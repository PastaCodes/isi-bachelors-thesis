...
La trasformazione di uscita, invece, prevede una fase iniziale di calcolo della posizione cartesiana, per poi passare alla posizione topocentrica e ai valori osservati. Dall'anomalia media passa all'anomalia eccentrica, secondo la formula~\ref{eq:mean2ecc}, poi dall'anomalia eccentrica all'anomalia vera, secondo la formula~\ref{eq:ecc2true}, e alla distanza radiale $r$, secondo la formula~\ref{eq:ecc2dist}. Dunque, la posizione è data dalla formula~\ref{eq:orbit2pos}.
...
% TODO: ricorda i crediti per i dataset usati!!!
