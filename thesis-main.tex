...
Per il calcolo di $R$ e $\theta$ si può sfruttare un servizio di effemeridi che fornisca le posizioni dell'osservatore e del Sole. In questo caso si è utilizzato il servizio JPL, sia attraverso le funzioni \lstinline{astropy.coordinates.solar_system.get_body_barycentric} e \lstinline{astropy.coordinates.earth.EarthLocation.get_gcrs_posvel}, che dalla piattaforma web \url{https://ssd.jpl.nasa.gov/horizons/app.html}. \\
