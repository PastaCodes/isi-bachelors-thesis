...
Si definisce l'argomento di latitudine $u=\omega+\nu$, così che le coordinate cartesiane del corpo siano date da:
\begin{equation}
...
n=\sqrt{\frac{\mu}{a^3}}
\end{equation}
Determinata l'anomalia media, si risale all'anomalia eccentrica esprimendo gli angoli in radianti e risolvendo l'equazione di Keplero tramite metodi numerici:
\begin{equation}
M=E-e\sin(E)
\end{equation}
...
\end{gather}
Infine, la distanza radiale dal fuoco occupato è legata all'anomalia eccentrica da:
\begin{equation}
r=a(1-e\cos(E))
\end{equation}
